						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/CarlLumhotz.jpg" width="230" height="350" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/CarlLumimg3.jpg" width="230" height="311" alt=""/></li>
			  <li>Carl S. Lumholtz - Arqueología Mexicana. No. 51. 2001.<br>
	          Dos varones tarahumaras, fotografiados en Tuaripa, Chihuahua, México</li>
		      </ul>
								    </section>
                                  <section>
											<header>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/CarlLumimg1.jpg" width="230" height="162" alt=""/><br>
                <em><a href="https://archive.org/details/agd6887.0001.001.umich.edu" target="_blank"><img src="../images/pagInternas/CarlLumimg2.jpg" width="230" height="352" alt=""/></a></em><br>
		      </li>
			  <li><em><a href="https://archive.org/details/agd6887.0001.001.umich.edu" target="_blank">El México desconocido.</a> </em>Carl Lumholtz</li>
