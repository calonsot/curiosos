    ...
    <title>Cándido Bolívar y Pieltain</title>
    </head>
						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/CandidoBolivarP.jpg" width="200" height="350" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list last-child">
              ...
              <li>Giral, F. 1994. Ciencia española en el exilio (1939-1989): El exilio de los científicos españoles. Anthropos y Centro de Investigación y Estudios Republicanos. Madrid, España. 395 p.</li>
              <li>Gomis, B.A. 1998. Homenaje a Cándido Bolívar (1897-1976) con motivo del centenario de su nacimiento. Llull: Revista de la Sociedad Española de Historia de las Ciencias y de las Técnicas, 21(41): 549-552.</li>
              <li>Naranjo, O.C. y M.A. Puig-Samper. 2007. Las redes de la ciencia: la JAE en el exilio. Asclepio. Revista de Historia de la Medicina y de la Ciencia 59(2):231-254.</li>
...
<ul class="link-list">
		      <li><img src="../images/pagInternas/CBolivarimg2.jpg" width="230" height="344" alt=""/></li>
		      <li>Insecto. Hemiptera<em></em></li>
...
<ul class="link-list">
              <li><img src="../images/pagInternas/CBolivarimg1.jpg" width="230" height="337" alt=""/><br>
              </li>
              <li><a href="http://cedros.residencia.csic.es/imagenes/Portal/ciencia/1940_01_01-z2.pdf" target="_blank">Revista hispano-americana de Ciencias puras y aplicadas</a>. (1940) </li>
			  </ul>
              </section>
                                  <section>
										  <header>
                                ...
                                <section>
									...
									<section>
										<h2>Línea del tiempo</h2><br>
										  <div class="row">
													<div id='timeline-embed' style="width: 100%; height: 500px;" start_at_slide="43"></div>
											</div>
									</section>
					</footer>
				</div>
