						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/GarradeJaguar.jpg" width="230" height="325" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/GarraJimg1.jpg" width="230" height="289" alt=""/></li>
			  <li>Archivo digital Museo Nacional de Antropología</li>
		      </ul>
                                    </section>
                                  <section>
											<header>
