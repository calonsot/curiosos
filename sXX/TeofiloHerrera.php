...
<html>
	<head>
	<title>Teófilo Herrera Suárez</title>
    </head>
						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/TeofiloHerreara.jpg" width="230" height="320" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list last-child">
			  <li>Herrera, S.T. 2003. Forjadores de la ciencia en la UNAM. Conferencias del ciclo Mi vida en la ciencia. UNAM, 596 p.</li>
              <li>Pérez-Silva,E. 1992. Teófilo Herrera Suárez. En: Dirección General de Asuntos del Personal Académico. Nuestros maestros. UNAM. 201-210.</li>
              </ul>
                                            </section>
								</div>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/TeofiloHimg3.jpg" width="230" height="344" alt=""/></li>
			  <li>Hongos<em> (Fungi)</em></li>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/TeofiloHimg1.jpg" width="219" height="335" alt=""/></li>
			  <li>Evangelina Pérez S., Teófilo Herrera S., <a href="https://books.google.com.mx/books?id=u9-YK0lu5ywC&printsec=frontcover&dq=Teófilo+Herrera+Suárez&hl=es&sa=X&ved=0ahUKEwj-odHr9q3PAhXqzIMKHQfpCjkQ6AEIGzAA#v=onepage&q=Teófilo Herrera Suárez&f=false" target="_blank"><em>Iconografía de Macromicetos de México</em></a><em></em>. Instituto de Biología, UNAM </li>
			  </ul>
				</section>
                                  <section>
										  <header>
