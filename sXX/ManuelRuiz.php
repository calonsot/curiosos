    ...
    <title>Manuel Ruiz Oronoz</title>
    </head>
						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/ManuelRuiz.jpg" width="230" height="375" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/ManuelROimg3.jpg" width="230" height="319" alt=""/></li>
			  <li>Hongo <em>(Podaxis pistillaris)</em></li>
			  <li>Foto: José Alfonso Sánchez Villegas / Banco de imágenes, CONABIO</li>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/ManuelROimg1.jpg" width="230" height="307" alt=""/><br>
		        <br>
              <img src="../images/pagInternas/ManuelROimg2.jpg" width="230" height="173" alt=""/>									  </li>
			  <li><em>
		        Tratado elemental de Botánica,
			        </em>Manuel Ruiz Oronoz.
			      1970</li>
              <li> Imagen: Todocoleccion.net </li>
			  </ul>
				</section>
                                  <section>
										  <header>
                                ...
                                <section>
									...
									<section>
										<h2>Línea del tiempo</h2><br>
										  <div class="row">
													<div id='timeline-embed' style="width: 100%; height: 500px;" start_at_slide="50"></div>
											</div>
									</section>
					</footer>
				</div>
