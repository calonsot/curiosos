    ...
    <title>Arturo Gómez Pompa</title>
    </head>
						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/Arturo Gomez Pompa.jpg" width="230" height="385" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
                                ...
                                <section>
									...
									<section>
										<h2>Línea del tiempo</h2><br>
										  <div class="row">
													<div id='timeline-embed' style="width: 100%; height: 500px;" start_at_slide="77"></div>
											</div>
									</section>
					</footer>
				</div>
