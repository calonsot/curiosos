						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><!-- InstanceBeginEditable name="Img_Personaje" --><img src="../images/personajes/AntonioBadan.jpg" width="230" height="325" alt=""/><!-- InstanceEndEditable --></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
                                ...
                                <div class="6u 12u(mobile) important(mobile)">
									...
									<!-- Main Content -->
										<section>
											<header>
												<h2><!-- InstanceBeginEditable name="Nombre_personaje" --><strong>Antonio Badán Dangon</strong><!-- InstanceEndEditable --></h2>
								...
								<div class="3u 12u(mobile)">
                                  ...
                                  <section>
									...
									<ul class="link-list">
									  <li><img src="../images/pagInternas/AntonioBadan.jpg" width="230" height="344" alt=""/></li>
                                      <li>Academia Mexicana de Ciencias<br>
Boletín AMC/172/11<br>
<em><a href="http://www.comunicacion.amc.edu.mx/comunicados/antoine-badan-un-cientifico-humanista" target="_blank">Antoine Badan, un científico humanista</a></em></li>
