						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><!-- InstanceBeginEditable name="Img_Personaje" --><img src="../images/personajes/FranciscoContrerasEspinosa.jpg" width="230" height="370" alt=""/><!-- InstanceEndEditable --></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
											...
											<ul class="link-list last-child">
											  <li>Aguilar, V., M. Kolb, D. Hernández, T. Urquiza, P. Koleff 2008. <a href="http://www.biodiversidad.gob.mx/Biodiversitas/Articulos/biodiv79art1.pdf" target="_blank">Prioridades de conservación de la biodiversidad marina de México</a>. CONABIO. Biodiversitas 79: 1-5.</li>
                                              <li></li>
                                            </ul>
											<!-- InstanceEndEditable -->
                                            </section>
                                ...
                                <div class="6u 12u(mobile) important(mobile)">
									...
									<!-- Main Content -->
										<section>
											<header>
												<h2><!-- InstanceBeginEditable name="Nombre_personaje" --><strong>Francisco Contreras Espinosa</strong><!-- InstanceEndEditable --></h2>
												<h3><!-- InstanceBeginEditable name="Periodo_vida" -->1948 - 2005<!-- InstanceEndEditable --></h3>
											</header>
                                            ...
                                            <p>Ocupé diversos cargos administrativos, impartí muchísimos cursos de licenciatura y publiqué varios libros, uno de ellos titulado &ldquo;Las Lagunas Costeras Mexicanas&rdquo;, el cual fue un importante referente por décadas. </p>
								...
								<div class="3u 12u(mobile)">
                                  ...
                                  <section>
											...
											<ul class="link-list">
											  <li><img src="../images/pagInternas/FcoContrerasimg2.jpg" width="230" height="344" alt=""/></li>
											  <li>Laguna. Ocosingo, Chiapas</li>
											  <li>Foto: Iván Montes de Oca Cacheux / Banco de imágenes, CONABIO</li>
											</ul>
                                          <!-- InstanceEndEditable --></section>
                                  <section>
											<header>
                                  ...
                                  <section>
									...
									<ul class="link-list">
									  <li><img src="../images/pagInternas/FcoContrerasimg1.jpg" width="230" height="299" alt=""/></li>
                                      <li>Contreras E., Francisco y Castañeda L., Ofelia. (2004). <a href="http://www.revistaciencias.unam.mx/es/77-revistas/revista-ciencias-76/618-la-biodiversidad-de-las-lagunas-costeras.html" target="_blank">La biodiversidad de las lagunas costeras</a>. <em>Ciencias</em> 76, octubre-diciembre, 46-56. [En línea]</li>
									</ul><!-- InstanceEndEditable --></section>
                                  <section>
										  <header>
										    <ul class="link-list">
                                ...
                                <section>
									...
									<section>
										<h2>Línea del tiempo</h2><br>
										  <div class="row">
													<div id='timeline-embed' style="width: 100%; height: 500px;" start_at_slide="89"></div>
											</div>
									</section>
					</footer>
				</div>
