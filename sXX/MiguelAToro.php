						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/MiguelAToro.jpg" width="230" height="430" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/MiguelATimg4.jpg" width="230" height="344" alt=""/></li>
			  <li>Jaguarundi <em>(Puma yagouaroundi)</em></li>
			  <li>Foto: Miguel A. Sicilia Manzo / Banco de imágenes, CONABIO</li>
			  <li><img src="../images/pagInternas/MiguelATimg3.jpg" width="230" height="102" alt=""/></li>
			  <li>Imagen:<a href="http://www.turismochiapas.gob.mx/sectur/zoolgico-miguel-lvarez-del-toro" target="_blank"> Zoológico Miguel Álvarez del Toro, Chiapas</a></li>
			  </ul>
								    </section>
                                  <section>
											<header>
...
<ul class="link-list last-child">
              <li><img src="../images/pagInternas/MiguelATimg1.jpg" width="230" height="333" alt=""/></li>
              <li>Miguel Álvarez del Toro. <em>Los Reptiles de Chiapas</em>. Gobierno del Estado e Instituto de Ciencias y Artes de Chiapas.</li>
              <li><img src="../images/pagInternas/MiguelATimg2.jpg" width="230" height="298" alt=""/></li>
              <li>Miguel Álvarez Del Toro.<em> Lista de las Aves de Chiapas</em>. Instituto de Ciencias y Artes de Chiapas</li>
