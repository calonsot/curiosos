    ...
    <title>Aldo Starker Leopold</title>
    </head>
						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/StarkerLeopold.jpg" width="230" height="315" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list">
			  <li></li>
              <li><img src="../images/pagInternas/AldoSatarkerImg1.jpg" width="230" height="348" alt=""/></li>
