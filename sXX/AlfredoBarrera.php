						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/AlfredoBarreraM.jpg" width="204" height="350" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/AlfBMimg4.jpg" width="230" height="344" alt=""/></li>
			  <li>Amate <em>(Ficus sp.)</em></li>
			  <li>Foto: Isaí Domínguez Guerrero / Banco de imágenes, CONABIO
			  <li><img src="../images/pagInternas/AlfBMimg3.jpg" width="230" height="287" alt=""/></li>
			      <li>Mosquito <em>(Aedes triseriatus)</em></li>
			      <li>Foto: David A. González Villareal / Banco de imágenes, CONABIO</li>
		      </ul>
                                    </section>
                                  <section>
											<header>
