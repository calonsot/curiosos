							...
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										...
										<section>
											<header><ul class="link-list last-child">
												<h2>Referencias</h2>
											</header>
                                ...
                                <div class="6u 12u(mobile) important(mobile)">
									...
									<!-- Main Content -->
										<section>
											...
											<p>Nací en Puebla en 1919. Realicé mis estudios de licenciatura, maestría y doctorado en Biología en la Facultad de Ciencias de la Universidad Nacional Autónoma de México (UNAM). En 1948 realicé estudios de especialización en acarología, en la Universidad de Duke y en el Museo Smithsoniano en Estados Unidos.</p>
                                          <p>Además de dedicarme a la investigación, impartí clases sobre este grupo de pequeños artrópodos, así como de bioespeleología, en el Instituto Politécnico Nacional (IPN) y en la UNAM. Fundé tres laboratorios para el estudio de estos organismos, uno en la Escuela Nacional de Ciencias Biológicas del IPN, el primero en América Latina, otro en la Facultad de Ciencias de la UNAM, y el tercero en el Instituto de Biología, perteneciente a la misma institución. Además, a este último doné su colección de ácaros y su hemeroteca personal, con lo que contribuí a la creación de la Colección Acarológica Nacional (CNAC), la más importante en el país hasta ahora.</p>
                                          <p>Escribí alrededor de 130 artículos sobre ácaros y fuí autora de 10 libros, entre los que se encuentran <em>Manual de Bioespeleología</em> y <em>Los Ácaros</em>. Fallecí en la ciudad de México en 2007.</p>
                                          </section>
