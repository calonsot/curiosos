						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/RamonRibaN.jpg" width="230" height="345" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list last-child">
			  <li>Toledo, T. 2009. <a href="http://www.biodiversidad.gob.mx/Biodiversitas/Articulos/biodiv83art1.pdf" target="_blank">El bosque de niebla</a>. CONABIO, Biodiversitas 83:1-6</li>
		      </ul>
                                          </section>
								</div>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/RRibayNimg2.jpg" width="230" height="304" alt=""/></li>
			  <li>Helecho <em>(Filicopsida)</em></li>
...
<ul class="link-list">
		      <li><img src="../images/pagInternas/RRibayNimg1.jpg" width="230" height="287" alt=""/></li>
              <li><a href="http://www.tropicos.org/Project/FM" target="_blank">Flora Mesoamericana</a>. <br>
Missouri Botanical Garden, Universidad Nacional Autónoma de México, The Natural History Museum (London)</li>
			  </ul>
				</section>
                                  <section>
										  <header>
