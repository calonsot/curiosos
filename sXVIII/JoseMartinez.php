    ...
    <title>José Martínez de Lejarza</title>
    </head>
      <section>
										<br>
										  <div class="row">
													<div id='timeline-embed' style="width: 100%; height: 500px;" start_at_slide="18"></div>
											</div>
									</section><br><br>
	<body class="subpage">
						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/JuanJoseMartinezdeLejarza.jpg" width="220" height="320" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list last-child">
              ...
              <li>Tavera, A.X. 1979. Juan José Martínez de Lejarza: un estudio de luz y sombra. INAH, Centro Regional México-Michoacán. México. 86 p.</li>
              <li>Urbina, L.G.,P. Henríquez y N. Rangel. 1985. Antología del Centenario: Estudio documentado de la literatura mexicana durante el primer siglo de independencia (1800-1821). Primera Parte II. Universidad Nacional Autónoma de México. 793 p.</li>
              <li></li>
              </ul>
									</section>
								</div>
...
<p>Fallecí en 1824 y mi obra Novorum Vegetabilium Descriptiones, que se publicó después de mi muerte, es el primer estudio sistemático de orquídeas y de otras plantas de Michoacán. Un año después, se publicó la segunda parte de mi obra que incluye aportaciones del naturalista <a href="http://www.biodiversidad.gob.mx/biodiversidad/curiosos/sXVIII/JoseMartinez.php">Pablo de la Llave, </a>como las descripciones de cien especies de plantas, varias desconocidas hasta entonces.</p>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/PdelaLlimg2.jpg" width="230" height="303" alt=""/></li>
			  <li>Orquídeas de Michoacán</li>
			  <li>Vainilla <em>(Vainilla planifolia)</em><br>
			    Foto: Iván Montes de Oca / Banco de imágenes, CONABIO										      </li>
		      </ul>
                                    </section>
                                  <section>
											<header>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/Lejarza.jpg" width="230" height="300" alt=""/></li>
              </ul>
							      </section>
                                  <section>
									<header>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/JMtezLejarzaimg3.jpg" width="230" height="310" alt=""/></li>
			  <li><a href="http://bdh-rd.bne.es/viewer.vm?id=0000061202&page=1" target="_blank"><em>Análisis estadístico de la provincia de Michoacan en 1822</em></a><br>
		      Fuente: Biblioteca digital del Patrimonio Iberoamericano</li>
			  </ul>
				 </section>
                                  <section>
										  <header>
