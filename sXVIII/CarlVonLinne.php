...
<ul class="link-list">
			  <li><img src="../images/pagInternas/CarlVonimg1.jpg" width="230" height="345" alt=""/></li>
			  <li><em>Primeros escritos de Carl von Linné</em><br>
	          </li>
		      </ul>
                                    </section>
                                  <section>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/CarlVonimg2.jpg" width="230" height="359" alt=""/></li>
			  <li><a href="https://www.wdl.org/es/item/3038/#q=Carl+Von+Linne&qla=es" target="_blank"><em>Primeros escritos de Carl von Linné</em></a>. Biblioteca Nacional de Suecia. <br>
			    Fuente:
		      Biblioteca digital mundial</li>
			  </ul>
				</section>
                                  <section>
										  <header>
