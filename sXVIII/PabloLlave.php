						...
						<div class="container">
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Left Sidebar -->
										<section>
											<header><img src="../images/personajes/PabloLlave.jpg" width="230" height="315" alt=""/></header>
</section>
										<section>
											<header>
												<h2>Referencias</h2>
...
<ul class="link-list last-child">
              <li>De la Torre, S.L. et.al. 2001. <em>Estudio introductorio</em>. En: Pi-Suñer, L.A. (coord.) México en el diccionario universal de historia y de geografía, Vol II. Ciencia y tecnología. Universidad Nacional Autónoma de México. 342 pp.</li>
              <li> Huerta, J. A. 1999. Pablo de la Llave, un ilustrado entre dos siglos y dos mundos. <em>Llull</em> 22(44): 421-430. </li>
              <li>Cuevas, C.M. de C. y C. López. 2009. Cambios de gobierno en la vida de un botánico mexicano: Maximino Martínez (1888-1964). HMex LVIII (3): 973-1004.</li>
              <li>Sierra, J., et. al. 1985. Antología del Centenario: Estudio documentado de la literatura mexicana durante el primer siglo de independencia (1800-1821), Primera Parte. Nueva biblioteca mexicana. Universidad Nacional Autónoma de México, Imprenta Universitaria 1935-1985.</li>
              <li></li>
              </ul>
                                          </section>
								</div>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/JMtezLejarzaimg2.jpg" width="230" height="344" alt=""/></li>
...
<ul class="link-list">
			  <li><img src="../images/pagInternas/PdelaLlimg1.jpg" width="230" height="318" alt=""/></li>
			  <li><a href="https://archive.org/details/novorumvegetabi00lexagoog" target="_blank"><em>Novorum vegetabilium descriptiones</em></a>. Pablo de la Llave, Juan Martínez de Lexarsa. Volúmen 1<br>
		      Fuente: Archive.org</li>
			  </ul>
				</section>
                                  <section>
										  <header>
